...
# Setup
require(foreign)
mex <- read.dta("C:/Users/Jill/Desktop/mex2000.dta")
...
sd2.effects
#An alternative way to check the substantive effects of the explanatory variables
#The results support the previous results that rightide has the greatest substantive effect.
